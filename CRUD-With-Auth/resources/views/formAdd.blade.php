                        ...
                        <div class="row my-3">
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <img id="myImg2" src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png" alt="" srcset="" width="100%">
                                    <input type="file" name="fotoCustomer" onchange="loadFile1(event)">
                                </div>
                            </div>
                        </div>
                        <div class="text-primary my-2">
