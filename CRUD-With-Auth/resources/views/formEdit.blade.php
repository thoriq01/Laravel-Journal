<div class="modal fade myModalBs" id="myModel{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('customer.update',$data->id)}}" method="POST" id="myForm" class="myForm">
                    @csrf
                    @method('put')
                    ...
                    <button id="myButton" type="button" class="btn btn-warning myButton"> Edit </button>
